...
def setup_logging_environment() -> bool:
    ...
    if os.environ.get('CASCADE_DEBUG_UNICODE') == '1':
        ...
        print(f"Test symbols: {symbols.SUCCESS} {symbols.CRITICAL} {symbols.HIGH}", file=sys.stderr)
...
def format_module_metrics(module: str, imports: int, imported_by: int, impact: float) -> str:
...
if __name__ == "__main__":
    ...
    print(f"Dependency chain: {format_dependency_chain(['moduleA', 'moduleB', 'moduleC'])}")
